            ...
            <div class="site-header__menu group">
                <nav class="main-navigation">
                    ...
                    <ul>
                        ...
                        <li <?php if (get_post_type() == 'post' or is_page('past-events')) echo 'class="current-menu-item"' ?>><a href="<?php echo site_url('/blog') ?>">Blog</a></li>
                    </ul>
                </nav>
                <div class="site-header__util">
                    ...
                    ?>
                        <a href="<?php echo esc_url(site_url('/my-notes')) ?>" class="btn btn--small btn--orange float-left push-right">My Nots</a>
                    ...
                    <!-- <a href="<?php //esc_url(site_url('/search eee')) 
